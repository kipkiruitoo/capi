...
return [
    ...
    */
    ...
    |
    */
    'title'    => 'Sondage - CAPI MANAGEMENT SYSTEM',
    ...
    |
    */
    'description' => 'Computer-Assisted Personal Interviews (CAPI) is a face-to-face data collection method in which the interviewer uses a tablet, mobile phone or a computer to record answers given during the interview. Sondage Comes with a full on capi system',
    ...
    */
    ...
    |
    */
    'keywords' => 'What is Capi, Capi systems in Nairobi, Sondage, Research softwares Providers in Nairobi, Capi systems in Nairobi',
