                    ...
                    elements: [
                        {
                            ...
                            title:
                                "Unique Case ID / Cluster Number (if applicable):",
                            inputType: "number",
                            hideNumber: true
                        },
                        {
            ...
            elements: [
                {
                    type: "boolean",
                    name:
                        "is_the_person_providing_the_information_is_the_patient",
                    title:
                        "Is the person providing the information is the patient?",
                    isRequired: true,
                    labelTrue: "Yes",
                    labelFalse: "No",
                    hideNumber: true
                },
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            type: "panel",
                            name:
                                "case_identifier_information_patient_date_of_birth_panel",
                            elements: [
                                {
                                    type: "text",
                                    name:
                            ...
                            elements: [
                                {
                                    type: "text",
                                    name:
                                        "case_identifier_information_patient_age_years",
                                    visibleIf:
                                ...
                                },
                                {
                                    type: "text",
                                    name:
                                        "case_identifier_information_patient_age_months",
                                    visibleIf:
                                        "{case_identifier_information_patient_age_checkbox} empty",
                                    startWithNewLine: false,
                                    title: "Months:",
                                ...
                                },
                                {
                                    type: "checkbox",
                                    name:
                                        "case_identifier_information_patient_age_checkbox",
                                    startWithNewLine: false,
                                    titleLocation: "hidden",
                                    choices: ["Unknown"]
                                }
                        ...
                        },
                        {
                            type: "dropdown",
                            name:
                                "case_identifier_information_patient_country_of_residence",
                        ...
                        },
                        {
                            type: "radiogroup",
                            name:
                                "case_identifier_information_patient_case_status",
                            startWithNewLine: false,
                            title: "Case status",
                            choices: [
                                {
                            ...
                            elements: [
                                {
                                    ...
                                    enableIf:
                                        "{date_of_first_symptom_onset_checkbox} empty",
                                    titleLocation: "hidden",
                                    inputType: "date",
                                    width: "314px"
                                },
                                {
                                    type: "checkbox",
                                    name:
                                        "date_of_first_symptom_onset_checkbox",
                                    startWithNewLine: false,
                                    titleLocation: "hidden",
                                    choices: [
                                        {
                ...
                },
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            type: "radiogroup",
                            name:
                                "what_type_of_respiratory_sample_was_collected",
                            title:
                        ...
                        },
                        {
                            ...
                            elements: [
                                ...
                                },
                                {
                                    type: "text",
                                    name:
                                        "were_other_samples_collected_textbox",
                                    visibleIf:
                    ...
                    elements: [
                        {
                            ...
                            elements: [
                                ...
                                },
                                {
                                    ...
                                    enableIf:
                                        "{hospitalization_required_radio} = 'item1'",
                                    startWithNewLine: false,
                        ...
                        },
                        {
                            ...
                            title:
                                "ICU (Intensive Care Unit) admission required",
                            titleLocation: "left",
                            choices: [
                                {
                                    value: "item1",
                            ...
                            elements: [
                                {
                                    ...
                                    choices: [
                                        ...
                                        },
                                        {
                                            value: "item3",
                                            text:
                                                "Not applicable (no X-ray performed)"
                                        }
                                    ],
                                    colCount: 3
                                },
                                {
                                    ...
                                    enableIf:
                                        "{pneumonia_by_chest_xray_radio} = 'item1'",
                                    startWithNewLine: false,
                                    title: "Date",
                                    titleLocation: "left",
                                    width: "313px",
            ...
            elements: [
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            type: "panel",
                            name:
                                "patient_attended_festival_or_mass_gathering_panel",
                            elements: [
                                {
                                    type: "radiogroup",
                                    name:
                                        "patient_attended_festival_or_mass_gathering_radio",
                                    width: "50%",
                                    titleLocation: "hidden",
                                    choices: [
                                        {
                                ...
                                },
                                {
                                    type: "text",
                                    name:
                                        "patient_attended_festival_or_mass_gathering_specify",
                                    enableIf:
                            ...
                            title:
                                "Patient attended festival or mass gathering",
                            showQuestionNumbers: "off"
                        },
                        {
                            type: "radiogroup",
                            name:
                                "patient_exposed_to_person_with_similar_illness",
                            title:
                                "Patient exposed to person with similar illness",
                            width: "50%",
                            hideNumber: true,
                            choices: [
                                {
                        ...
                        },
                        {
                            ...
                            elements: [
                                ...
                                },
                                {
                                    type: "panel",
                                    name:
                                        "patient_visited_outpatient_treatment_facility_panel",
                                    elements: [
                                        {
                                            type: "radiogroup",
                                            name:
                                ...
                                },
                                {
                                    type: "panel",
                                    name:
                                        "patient_visited_traditional_healer_panel",
                                    elements: [
                                        {
                                            type: "radiogroup",
                                            name:
                                                "patient_visited_traditional_healer_radio",
                                            width: "50%",
                                            titleLocation: "hidden",
                                            choices: [
                                                {
                                        ...
                                        },
                                        {
                                            type: "text",
                                            name:
                                                "patient_visited_traditional_healer_specify",
                                            enableIf:
                ...
                },
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            visibleIf:
                                "{status_of_form_completion_boolean} = false",
                            title: "Reason:",
                            hasOther: true,
                            choices: [
                                {
...
for (var i = 0; i < survey.visiblePageCount; i++) {
    ...
    if (!!survey.visiblePages[i].navigationDescription) {
        pageDescription.innerText =
            survey.visiblePages[i].navigationDescription;
    }
