...
Route::get('/agent/{id}/results/{interview}', 'AgentController@results')->middleware('auth');
...
Route::get('/feedbackexports', function () {
    return  Excel::download(new FeedbackExport, 'feedback.xlsx');
})->name('feedbackexports');
...
Route::get('/analytics/{id}', 'AnalyticsController@index')->name('analytics')->middleware('auth');
